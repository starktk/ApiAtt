...
class CharacterUseCase {
    ...
    suspend fun adicionarPersonagem(name: String, description: String, age: Int, birth_date: String,
        ...
        characterRepository.addPersonagem(id, characterRequest)
    }
    private fun convert(name: String, description: String,
        ...
        return CharacterRequest(name, description, url_image, select_univerType, select_heroType, age, url_image)
    }
}